...
<html lang="id-ID">
    <head>
        ...
        <link href="<?php echo get_theme_uri('custom/auth/login/css/style8.css'); ?>" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <a href="<?php  echo base_url(); ?>index.php/Home/index"><span class="fas fa-home text-red"></span></a>
            <h2>Login Akun</h2>
