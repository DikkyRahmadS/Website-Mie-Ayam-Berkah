		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				...
				<div class="col-lg-6 col-5 text-right">
					<a href="<?php echo site_url('admin/customers/add_new_customer'); ?>" class="btn btn-sm btn-neutral">Tambah</a>
				</div>
			</div>
		</div>
	</div>
				...
				"columns": [{
					...
					},
					{
						"mRender": function(data, type, row) {
							...
							return '<div class="text-right">' + '<a href="' + url + '" class="btn btn-warning btn-sm ml-2"><i class="fa fa-edit"></i></a>' +
								'<a href="#" data-id="' + row.id + '" class="btn btn-danger btn-sm btnDelete"><i class="fa fa-trash"></i></a>' + '</div>';
						}
					}
				],
				"language": {
